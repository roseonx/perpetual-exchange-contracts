...
contract SwapHandler is Ownable, ReentrancyGuard, BaseConstants, ISwapHandler, IUniswapV3SwapCallback {
    ...
    function swapFromInternal(
        ...
        require(_tokenIn == bond.token && _tokenIn != address(0), "Invalid bond token to swap");
