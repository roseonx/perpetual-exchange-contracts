...
contract SwapRouter is Ownable, ReentrancyGuard, BaseConstants, ISwapRouter, IUniswapV3SwapCallback {
    ...
    function swapFromInternal(
        ...
        require(_amountIn == bond.amount, "Insufficient bond amount to swap");
        require(_tokenIn == bond.token, "Invalid bond token to swap");
        require(bond.owner == _account, "Invalid bond owner to swap");
