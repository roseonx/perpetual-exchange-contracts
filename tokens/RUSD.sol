...
contract RUSD is IRUSD, Ownable {
    ...
    function _burn(address _account, uint256 _amount) internal {
        require(_account != address(0), "RUSD: burn from the zero address");

        require(balances[_account] >= _amount, "RUSD: burn amount exceeds balance");
    ...
    function _mint(address _account, uint256 _amount) internal {
        require(_account != address(0), "RUSD: mint to the zero address");
        totalSupply += _amount;
        balances[_account] += _amount;
