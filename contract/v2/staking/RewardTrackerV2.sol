...
contract RewardTrackerV2 is OwnableUpgradeable, IERC20Upgradeable, ReentrancyGuardUpgradeable, IRewardTrackerV2, UUPSUpgradeable {
    ...
    function finalInitialize(
        ...
        require(!isFinalInitialized, "RewardTracker: already initialized");
        ...
        emit FinalInitialize(_depositTokens, _distributor);
    }
    ...
    function tokensPerInterval() external override view returns (uint256) {
        return IRewardDistributorV2(distributor).tokensPerInterval();
    }
    ...
    function claimable(address _account) public override view returns (uint256) {
        ...
        uint256 pendingRewards = IRewardDistributorV2(distributor).pendingRewards() * PRECISION;
    ...
    function rewardToken() public view returns (address) {
        return IRewardDistributorV2(distributor).rewardToken();
    }
    ...
    function _updateRewards(address _account) private {
        uint256 blockReward = IRewardDistributorV2(distributor).distribute();
